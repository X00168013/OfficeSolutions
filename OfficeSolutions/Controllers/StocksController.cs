...
namespace OfficeSolutions.Controllers
{
    public class StocksController : Controller
    {
        ...
        public StocksController(OfficeSolutionsContext context)
        {
            _context = context;
        }
        ...
        {
            var officeSolutionsContext = _context.Stocks.Include(s => s.Shop);
            return View(await officeSolutionsContext.ToListAsync());
        }
